...
#if !defined(UNITY_COLOR_INCLUDED) && !SHADER_API_METAL && !SHADER_API_VULKAN //Already defined
...
#if !defined(URP) && !defined(UNITY_COMMON_INCLUDED) //Backported to Built-in RP
